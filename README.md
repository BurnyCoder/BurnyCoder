...
- [Software for autonomous drones](https://github.com/BurnyCoder/DJI-MSDK-to-PC) Autonomous drone using AI agent with vision analysis capabilities, realtime person tracking, live control using keyboard, live video stream, live queries data.
...
##### Artificial intelligence / machine learning
- [Jarvis Waifu Supervisor](https://github.com/BurnyCoder/jarvis-waifu-supervisor): AI-powered productivity monitor that watches your screen and webcam to keep you focused on your tasks. Deep work loop with Vision LLM and TTS, blocking websites and apps.
...
- Also see my [YouTube channel](https://www.youtube.com/@burnytech).
